...
var remotePowerCostLineItem = dom("remote-power-line-item");
...
//set defaults
//inputs
guestsInput = guestsSlider.value = 0;
customSongsInput = customSongsSlider.value = 0;
cocktailHourAddedTimeInput = cocktailHourAddedTimeSlider.value = 0;
dinnerAddedTimeInput = dinnerAddedTimeSlider.value = 0;
hornsInput = hornsSlider.value = 0;
djAddedTimeInput = djAddedTimeSlider.value = 0;
djLiveDancesInput = djLiveDancesSlider.value = 0;
bandAddedPlayersInput = bandAddedPlayersSlider.value = 0;
bandAddedTimeInput = bandAddedTimeSlider.value = 0;
silentDiscoInput = silentDiscoSlider.value = 0;
