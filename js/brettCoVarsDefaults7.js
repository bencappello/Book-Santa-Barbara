...
customSongsSlider.value = 0;
cocktailHourAddedTimeSlider.value = 0;
dinnerAddedTimeSlider.value = 0;
hornsSlider.value = 0;
djAddedTimeSlider.value = 0;
djLiveDancesSlider.value = 0;
bandAddedPlayersSlider.value = 0;
bandAddedTimeSlider.value = 0;
silentDiscoSlider.value = 0;
