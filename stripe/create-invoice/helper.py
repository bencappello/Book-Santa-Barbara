...
pandadoc_token = os.getenv("PANDADOC_API_KEY")
...
def return_data(request_json):
    print("!!!!!! return_data FUNCTION INVOKED !!!!!!!!!!")
...
# ** create_invoices_helper converts values to cents, stripe takes in values in cents
def create_invoices_helper(
        remainder_fee,
        deposit_fee,
        customer_id,
        split_type,
    ...
    print("!!!!!! create_invoices_helper FUNCTION INVOKED !!!!!!!!!!")
